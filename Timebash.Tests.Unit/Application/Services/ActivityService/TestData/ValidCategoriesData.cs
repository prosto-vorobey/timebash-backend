...
public class ValidCategoriesData : IEnumerable<object[]>
{
    ...
    public IEnumerator<object[]> GetEnumerator()
    {
        ...
        yield return new object[] { userId, categoryIds.Take(1).ToList(), categories.Take(1).ToList() };
        yield return new object[] { userId, categoryIds, categories };
    }
