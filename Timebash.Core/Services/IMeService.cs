...
public interface IMeService
{
    ...
    Task<UserResponse> GetAsync(Guid userId);
    ...
    Task<JournalsListResponse> GetJournalsAsync(Guid userId);
    ...
    Task<CategoriesListResponse> GetCategoriesAsync(Guid userId);
    ...
    Task<JournalResponse> GetDefaultJournalAsync(Guid userId);
    ...
    /// <exception cref="NotFoundException">Thrown when the user does not exist.</exception>
    Task<bool> UpdateNameAsync(UserNameUpdateRequest request, Guid userId);
    ...
    /// <exception cref="NotFoundException">Thrown when the user does not exist.</exception>
    Task<bool> UpdateEmailAsync(UserEmailUpdateRequest request, Guid userId);
    ...
    /// <exception cref="NotFoundException">Thrown when the user does not exist.</exception>
    Task<bool> UpdatePasswordAsync(PasswordUpdateRequest request, Guid userId);
    ...
    /// <returns>True if any changes were applied, otherwise false.</returns>
    /// <exception cref="NotFoundException">Thrown when the user or the associated default journal does not exist.</exception>
    Task<bool> UpdateDefaultJournalAsync(DefaultJournalUpdateRequest request, Guid userId);
