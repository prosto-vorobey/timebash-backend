...
public interface IActivityService
{
    ...
    Task<ActivityResponse> GetByIdAsync(Guid id, Guid userId, CancellationToken cancellationToken);
    ...
    /// <exception cref="BadRequestException">Thrown when <paramref name="id"/> is empty.</exception>
    /// <exception cref="NotFoundException">Thrown when the activity does not exist or does not belong to the user.</exception>
    Task<CategoriesListResponse> GetCategoriesByActivityIdAsync(Guid id, Guid userId, CancellationToken cancellationToken);
    ...
    Task<ActivityResponse> CreateAsync(ActivityRequest request, Guid userId, CancellationToken cancellationToken);
    ...
    Task<ActivityWithCorrectionResponse> CreateWithCorrectionAsync(
    ...
    Task<bool> AddCategoryToActivityAsync(Guid activityId, Guid categoryId, Guid userId, CancellationToken cancellationToken);
    ...
    Task<bool> AddCategoriesToActivityAsync(Guid activityId, ActivityCategoriesRequest request, Guid userId, CancellationToken cancellationToken);
    ...
    Task<bool> UpdateAsync(Guid id, ActivityRequest request, Guid userId, CancellationToken cancellationToken);
    ...
    Task<bool> UpdateActivityCategoriesAsync(Guid activityId, ActivityCategoriesRequest request, Guid userId, CancellationToken cancellationToken);
    ...
    /// <exception cref="BadRequestException">Thrown when <paramref name="activityId"/> or <paramref name="categoryId"/> is empty.</exception>
    /// <exception cref="NotFoundException">Thrown when the activity or category does not exist or does not belong to the user.</exception>
    Task<bool> RemoveCategoryFromActivityAsync(Guid activityId, Guid categoryId, Guid userId, CancellationToken cancellationToken);
}
